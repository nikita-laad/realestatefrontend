            ...
            <form action="search.html">
              <div className="form-row">
                ...
                <div className="col-md-4 mb-3">
                  ...
                  <select name="state" className="form-control"  defaultValue="">
              ...
              <div className="form-row">
                <div className="col-md-6 mb-3">
                  ...
                  <select name="bedrooms" className="form-control"  defaultValue="">
                ...
                <div className="col-md-6 mb-3">
                  <select name="price" className="form-control" id="type"  defaultValue="">
